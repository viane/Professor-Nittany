//////////        Set up         ////////////////
const displayDOMElement = $('#userQueryInput');
...
var initSocket = function(options, onopen, onlistening, onmessage, onerror, onclose) {
    ...
    var sessionPermissionsQueryParam = sessionPermissions
        ? '0'
        : '1';
...
var initRecordButton = function(ctx) {
    ...
    recordButton.click((function() {
        ...
        return function(evt) {
            ...
            if (!running) {
                displayDOMElement.val(''); // clear hypotheses from previous runs
